...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name="councilelectionresultset", name="confirmed_by"
        ),
        migrations.RemoveField(
            model_name="councilelectionresultset", name="is_rejected"
        ),
        migrations.RemoveField(
            model_name="councilelectionresultset", name="rejected_by"
        ),
        migrations.RemoveField(
            model_name="councilelectionresultset", name="rejected_source"
        ),
        migrations.AddField(
            model_name="councilelectionresultset",
            name="review_status",
