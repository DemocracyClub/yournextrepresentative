...
class IncompleteFieldView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for result in filtered_results.all():
            details = {
                ...
                "post": {"name": result.post.extra.short_label},
            }
    ...
    def get_results(self, results):
        ...
        if field == "twitter" or field == "facebook" or field == "phone":
            filtered_results = results.exclude(
                person__contact_details__contact_type=field
            )
        else:
