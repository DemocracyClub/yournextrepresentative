...
v09_api_router.register(r"images", v09views.ImageViewSet)
...
v09_api_router.register(r"complex_fields", v09views.ComplexPopoloFieldViewSet)
...
next_api_router.register(r"images", next_views.ImageViewSet)
...
next_api_router.register(
    r"complex_fields", next_views.ComplexPopoloFieldViewSet
)
