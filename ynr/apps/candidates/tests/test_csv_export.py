...
class CSVTests(TmpMediaRootMixin, TestUserMixin, UK2015ExamplesMixin, TestCase):
    ...
    def test_as_single_dict(self):
        ...
        self.assertEqual(len(membership_dict.keys()), 43)
    ...
    def test_csv_output(self):
        ...
        self.maxDiff = None
        example_output = (
            "id,name,election,ballot_paper_id,election_date,party_id,party_name,post_id,post_label,honorific_prefix,honorific_suffix,gender,birth_date,mapit_url,elected,email,twitter_username,facebook_page_url,party_ppc_page_url,facebook_personal_url,homepage_url,wikipedia_url,linkedin_url,image_url,proxy_image_url_template,image_copyright,image_uploading_user,image_uploading_user_notes,twitter_user_id,election_current,party_lists_in_use,party_list_position,old_person_ids,gss_code,parlparse_id,theyworkforyou_url,party_ec_id,favourite_biscuits,cancelled_poll,wikidata_id,blog_url,instagram_url,youtube_profile\r\n"
            + f"1953,Daithí McKay,parl.2010-05-06,parl.66135.2010-05-06,{earlier_election_date},party:39,Sinn Féin,66135,North Antrim,,,male,,,,,,,,,,,,,,,,,,False,False,,12;56,,,,PP39,,False,,,,\r\n"
            + f"2009,Tessa Jowell,parl.2010-05-06,parl.65808.2010-05-06,{earlier_election_date},party:53,Labour Party,65808,Dulwich and West Norwood,Ms,DBE,female,,,,jowell@example.com,,,,,,,,{tessa_image_url},,example-license,john,A photo of Tessa Jowell,,False,False,,,,uk.org.publicwhip/person/10326,http://www.theyworkforyou.com/mp/10326,PP53,,False,Q123456,,,\r\n"
            + f"1953,Daithí McKay,parl.2015-05-07,parl.66135.2015-05-07,{election_date},party:39,Sinn Féin,66135,North Antrim,,,male,,,,,,,,,,,,,,,,,,True,False,,12;56,,,,PP39,,False,,,,\r\n"
            + f"2009,Tessa Jowell,parl.2015-05-07,parl.65913.2015-05-07,{election_date},party:53,Labour Party,65913,Camberwell and Peckham,Ms,DBE,female,,,,jowell@example.com,,,,,,,,{tessa_image_url},,example-license,john,A photo of Tessa Jowell,,True,False,,,,uk.org.publicwhip/person/10326,http://www.theyworkforyou.com/mp/10326,PP53,,False,Q123456,,,\r\n"
        )
