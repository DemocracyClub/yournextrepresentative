...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "PERSON-ID", help="The ID of the person to add a new identifer for"
        )
        parser.add_argument("SCHEME", help="The scheme of the new identifier")
        parser.add_argument("IDENTIFIER", help="The identifier to add")
        parser.add_argument(
    ...
    def handle(self, *args, **options):
        ...
        person.identifiers.create(
            scheme=options["SCHEME"], identifier=options["IDENTIFIER"]
        )
