...
urlpatterns = [
    ...
    re_path(
        r"^elections/(?P<election_id>[^/]+)/election-sopns",
        views.SOPNsForElectionSummary.as_view(),
        name="election_sopns_summary",
    ),
    re_path(
        r"^elections/(?P<election_id>[^/]+)/election-sopn/(?P<pk>\d+)",
